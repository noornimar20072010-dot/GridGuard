...
export function Login() {
  ...
  <header className="sticky top-0 z-40 border-b border-line/80 bg-base/85 backdrop-blur">
    <nav className="mx-auto flex h-16 max-w-7xl items-center gap-6 px-5 lg:px-8" aria-label="Main">
      ...
      {/* Desktop links */}
      <ul className="ml-4 hidden items-center gap-1 text-sm text-muted lg:flex">
      ...
      <div className="ml-auto flex items-center gap-2">
        <span className="mr-1 hidden items-center gap-2 rounded-full border border-line bg-panel px-3 py-1.5 md:flex">
          ...
          <span className="font-mono text-[11px] tracking-wide text-muted">SIMULATED FEED · LIVE</span>
        </span>
        ...
        <button type="button" id="navToggle" aria-expanded="false" aria-controls="mobileNav"
          className="rounded-lg border border-line p-2 text-muted hover:text-ink lg:hidden">
    ...
    <div id="mobileNav" className="hidden border-t border-line bg-panel px-5 py-3 lg:hidden">
      <ul className="grid gap-1 text-sm">
        <li><a className="block rounded-md px-3 py-2 text-muted hover:bg-raised hover:text-ink"
            href="#features">Features</a></li>
        <li><a className="block rounded-md px-3 py-2 text-muted hover:bg-raised hover:text-ink" href="#how-it-works">How it
            works</a></li>
        <li><a className="block rounded-md px-3 py-2 text-muted hover:bg-raised hover:text-ink" href="#grid-tree">Grid
            tree</a></li>
        <li><a className="block rounded-md px-3 py-2 text-muted hover:bg-raised hover:text-ink" href="#ai-summary">AI
            summary</a></li>
      </ul>
    </div>
  </header>
  ...
  <main id="top">
    ...
    <section className="relative overflow-hidden hero-wash">
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-14 lg:px-8 lg:pb-24 lg:pt-20">
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.05fr)]">
          ...
          <div>
            <span
              className="inline-flex items-center gap-2 rounded-full border border-line bg-panel/80 px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.14em] text-muted">
            ...
            <dl className="mt-10 grid max-w-lg grid-cols-3 divide-x divide-line rounded-xl border border-line bg-panel/70">
              <div className="px-4 py-4">
                <dt className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted">Lead time</dt>
                <dd className="mt-1 font-mono text-xl font-bold text-ok">30 min</dd>
              </div>
              <div className="px-4 py-4">
                <dt className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted">Refresh</dt>
                <dd className="mt-1 font-mono text-xl font-bold">5 s</dd>
              </div>
              <div className="px-4 py-4">
                <dt className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted">Forecast</dt>
          ...
          <div className="relative">
            <div className="overflow-hidden rounded-2xl border border-line bg-panel shadow-2xl shadow-black/50">
              ...
              <div className="flex items-center gap-3 border-b border-line px-4 py-3">
                ...
                <span
                  className="ml-auto inline-flex items-center gap-1.5 rounded-md bg-crit/10 px-2 py-1 font-mono text-[10px] font-bold text-crit">
                  3 CRITICAL
                </span>
              </div>
                ...
                <div className="hidden border-r border-line p-3 sm:block">
                  <ul className="space-y-1 text-[12px]">
                    <li
                      ...
                      Overview</li>
                    <li className="px-2 py-2 text-muted">Grid tree</li>
                    <li className="px-2 py-2 text-muted">Transformers</li>
                    <li className="flex items-center justify-between px-2 py-2 text-muted">
                      Alerts
                      <span className="rounded bg-warn/15 px-1.5 font-mono text-[10px] font-bold text-warn">6</span>
                    </li>
                    <li className="px-2 py-2 text-muted">Reporting</li>
                  </ul>
                </div>
                ...
                <div className="space-y-3 p-3 sm:p-4">
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    <div className="rounded-lg border border-line bg-raised p-3">
                      <p className="font-mono text-[9px] uppercase tracking-[0.12em] text-muted">Total load</p>
                      <p className="mt-1.5 font-mono text-lg font-bold text-ok">11.2<span
                          className="ml-1 text-[10px] text-muted">GW</span></p>
                    </div>
                    <div className="rounded-lg border border-line bg-raised p-3">
                      <p className="font-mono text-[9px] uppercase tracking-[0.12em] text-muted">Transformers</p>
                      <p className="mt-1.5 font-mono text-lg font-bold">48<span
                          className="ml-1 text-[10px] text-muted">/50</span></p>
                    </div>
                    <div className="rounded-lg border border-line bg-raised p-3">
                      <p className="font-mono text-[9px] uppercase tracking-[0.12em] text-muted">At risk</p>
                  ...
                  <div className="rounded-lg border border-line bg-raised p-3">
                    <div className="flex items-baseline justify-between">
                      <p className="font-mono text-[10px] uppercase tracking-[0.12em] text-muted">T-104 · load history</p>
                      <p className="font-mono text-[10px] text-warn">PREDICTED 96% ▲</p>
                    </div>
                  ...
                  <div className="flex items-center gap-3 rounded-lg border border-crit/25 bg-crit/[0.07] p-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="truncate font-mono text-[10px] text-muted">96% in 28 min · shed 1.2 MW or reroute via
                        T-102</p>
                    </div>
                    <span
                      className="ml-auto hidden shrink-0 rounded bg-base px-2 py-1 font-mono text-[9px] text-muted sm:block">AI
                      SUMMARY</span>
                  </div>
                </div>
              </div>
    ...
    <section id="features" className="border-t border-line bg-base py-20">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <header className="max-w-2xl">
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-ok">Features</p>
    ...
    <section id="how-it-works" className="border-t border-line bg-panel/40 py-20">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <header className="max-w-2xl">
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-ok">How it works</p>
    ...
    <section id="grid-tree" className="border-t border-line bg-base py-20">
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-2 lg:px-8">
        <div>
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-ok">Grid tree</p>
        ...
        <div className="rounded-xl border border-line bg-panel p-5">
          <div className="flex items-center justify-between border-b border-line pb-3">
            <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-muted">Grid topology</p>
          ...
          <ul className="mt-4 space-y-1 font-mono text-[13px]">
            ...
            <li className="ml-5 space-y-1 border-l border-line pl-4">
              <p className="flex items-center gap-2 py-1.5 text-muted">
              ...
              <ul className="space-y-1">
                <li className="flex items-center gap-2 rounded-md px-2 py-1.5 hover:bg-raised">
                  ...
                  <span className="ml-auto text-[11px] text-muted">62%</span>
                </li>
                <li className="flex items-center gap-2 rounded-md px-2 py-1.5 hover:bg-raised">
                  <span className="h-2 w-2 rounded-full bg-ok"></span> T-102
                  <span className="ml-auto text-[11px] text-muted">58%</span>
                </li>
                <li className="flex items-center gap-2 rounded-md border-l-2 border-crit bg-crit/[0.08] px-2 py-1.5">
                  ...
                  <span className="ml-auto text-[11px] font-bold text-crit">96% ▲</span>
                </li>
              </ul>
              <p className="flex items-center gap-2 py-1.5 text-muted">
              ...
              <ul className="space-y-1">
                <li className="flex items-center gap-2 rounded-md px-2 py-1.5 hover:bg-raised">
                  ...
                  <span className="ml-auto text-[11px] text-muted">44%</span>
                </li>
                <li className="flex items-center gap-2 rounded-md px-2 py-1.5 hover:bg-raised">
                  <span className="h-2 w-2 rounded-full bg-warn"></span> T-202
                  <span className="ml-auto text-[11px] text-muted">81%</span>
                </li>
              </ul>
            </li>
          </ul>
      ...
      <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 lg:grid-cols-2 lg:px-8">
        ...
        <div className="order-2 rounded-xl border border-line bg-panel p-5 lg:order-1">
          <div className="flex items-center gap-2 border-b border-line pb-3">
            <span className="h-2 w-2 rounded-full bg-crit"></span>
            <p className="font-mono text-[11px] uppercase tracking-[0.14em] text-muted">Operator brief · T-104</p>
            <span className="ml-auto rounded bg-raised px-2 py-1 font-mono text-[9px] text-muted">GENERATED</span>
          </div>
          <div className="space-y-3 pt-4 text-sm leading-relaxed text-muted">
            <p>
          ...
          <p className="mt-4 border-t border-line pt-3 font-mono text-[10px] leading-relaxed text-muted/70">
        ...
        <div className="order-1 lg:order-2">
          <p className="font-mono text-[11px] uppercase tracking-[0.18em] text-ok">AI operator summary</p>
  ...
  <footer className="border-t border-line bg-panel/60">
    <div className="mx-auto flex max-w-7xl flex-col gap-6 px-5 py-10 lg:flex-row lg:items-center lg:px-8">
      ...
      <nav className="flex flex-wrap gap-x-6 gap-y-2 text-xs text-muted lg:ml-auto" aria-label="Footer">
  ...
  <div id="signinModal" className={`fixed inset-0 z-50 ${isModalOpen ? 'flex' : 'hidden'} items-center justify-center p-4`} role="dialog"
    ...
    <div className="relative w-full max-w-sm rounded-2xl border border-line bg-panel p-6 shadow-2xl">
      <button type="button" onClick={() => setIsModalOpen(false)}
        className="absolute right-4 top-4 rounded-md p-1 text-muted hover:bg-raised hover:text-ink">
      ...
      <p className="mt-1 text-sm text-muted">Access the GridGuard operations dashboard.</p>

      <form className="mt-6 space-y-4" onSubmit={(e) => { e.preventDefault(); navigate('/dashboard'); }} noValidate>
        <div>
          <label htmlFor="email" className="block text-xs font-medium text-muted">Email</label>
          <input id="email" name="email" type="email" autoComplete="email" required placeholder="operator@discom.in"
            className="mt-1.5 w-full rounded-lg border border-line bg-base px-3 py-2.5 text-sm placeholder:text-muted/50 focus:border-ok focus:outline-none" />
        </div>
        <div>
          <div className="flex items-baseline justify-between">
            <label htmlFor="password" className="block text-xs font-medium text-muted">Password</label>
        ...
        <p id="signinNote"
          className="hidden rounded-lg border border-warn/25 bg-warn/[0.08] px-3 py-2 font-mono text-[11px] leading-relaxed text-warn">
        </p>
      ...
      <p className="mt-5 border-t border-line pt-4 text-center font-mono text-[10px] leading-relaxed text-muted/70">
